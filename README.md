...
- 📖 **Readable Line Length Toggle** - Quickly toggle Obsidian's "Readable line length" setting directly from the popup
...
5. Toggle **Readable line length** to switch between fixed width and Obsidian's default readable length mode
